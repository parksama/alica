...
You who I want to see...</p>
			<h2>our friends will be united in</h2>
			<div class="countdown" data-until="<?php echo htmlspecialchars(date('c',strtotime($eta)), ENT_QUOTES) ?>">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-countdown/2.0.2/jquery.countdown.min.js" type="text/javascript"></script>
	<script>
		$(document).ready(function() {
			var eta = $('.countdown').data('until');
			$('.countdown').countdown({until: new Date(eta)});
		});
	</script>
